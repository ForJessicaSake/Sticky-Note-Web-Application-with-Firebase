        ...
        <Navbar/>
            ...
            <section className="body-font">
                <section className="container xxs:px-0 smm:px-12 px-0 lg:px-4 xlgs:px-12 py-12 mx-auto">
                        <article className="flex flex-wrap mt-6 mb-6 text-center">
            ...
            <section>
                <section className="container xxs:px-0 smm:px-12 lgs:px-12 lg:px-4 xlgs:px-20 py-12 mx-auto">
                    <article className="flex flex-wrap -m-4">
                        ...
                        <article className="p-4 lg:w-1/3 xxs:px-0 smm:px-0 lgs:px-2 w-full" data-aos="flip-up" data-aos-duration="1000">
