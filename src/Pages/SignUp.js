                        ...
                        <section className="login-input flex flex-col font-medium">
                            ...
                            <button
                                onClick={handleSignUp}
                                    className="border-purple bg-purple text-white w-96 mt-8 rounded-md items-center h-12 smm:text-2xl smm:h-14 xxs:w-80 xxs:ml-6 xxs:text-lg xxs:h-18 xms:text-xl xms:h-18"
                            >
                                Sign up
                            </button>
